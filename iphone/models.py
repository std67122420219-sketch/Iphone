from iphone.extensions import db, login_manager
...
class User(db.Model, UserMixin):
  ...
  iphones: Mapped[List['Iphone']] = relationship(back_populates='user')   
...
iphone_type = Table(
  ...
  Column('iphone_id', Integer, ForeignKey('iphone.id'), primary_key=True)  
)
...
class Type(db.Model):
  ...
  iphones: Mapped[List['Iphone']] = relationship(
    back_populates='types',
    secondary=iphone_type  
  )
...
class Iphone(db.Model):
  ...
  user: Mapped[User] = relationship(back_populates='iphones')   
  types: Mapped[List['Type']] = relationship(
    back_populates='iphones',
    secondary=iphone_type  
  )
